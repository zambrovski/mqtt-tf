 ...
 */
@Component
public class PressureChangedListener implements MqttCallback {
     ...
     * 
     */
    public PressureChangedListener() {
    ...
    public void init() {
        ...
        try {
            listener.registerListener("pressure", this);
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        logger.info(topic);
        logger.info("Pressure {}", message.toString());
